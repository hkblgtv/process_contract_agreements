...
# Configure Google Gemini API (replace with your actual API key or environment variable setup)
...
def main():
    ...
    try:
        ...
        llm_prompt_fields = {
            ...
            "End Date": "Scheduled Completion Date from Schedule J",
            "Project Milestones": "List all project milestones from Schedule J as a comma-separated list.",
        ...
        output_columns = [
            ...
            "Project Name", "Start Date", "End Date", "Project Milestones",
    ...
    for pdf_file in pdf_files:
        ...
        if extracted_data:
            ...
            row_data = {
                col: extracted_data.get(col, "") if extracted_data.get(col) is not None else ""
            ...
            if "Location" in row_data and "Location - State" in row_data:
